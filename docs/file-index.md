...
| `tests/e2e/scrape-page-state.spec.ts` | Direct coverage for `scrapePageStateInPage` — real / no / CodeMirror / empty / copy-event-fallback selections, `includeHtml` flag |
