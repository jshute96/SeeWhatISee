...
| `tests/e2e/jpg-png-cache-edit-sync.spec.ts` | E2E regression — JPG source: highlight → copy → repeat-copy keeps `.png` ext (cache-hit guard); undo-all still reverts to `.jpg` |
