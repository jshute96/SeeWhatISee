...
* **Clear** is now **Reset** ("Undo all edits"): it goes all the way back to the original capture, undoing any **View cropped** re-frame as well as the drawings (the README's Undo/Clear bullet needs the new name)
